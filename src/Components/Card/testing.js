...
const Display = (props) => {
  ...
  const agreeAndRedirect = () => {
    ...
    // Call the function passed from QuestionPage to change isSolutionAccepted state
  ...
  return (
    ...
    <Cont>
      ...
      >
        ...
        >
          <Topic>
            <div style={{ cursor: 'pointer' }} onClick={openPopup}>
              <Anchor
                color={themeColor[currTheme][0].text}
                target="_blank"
              >
            ...
            <Popup open={showPopup} closeOnDocumentClick onClose={closePopup}>
              <div>
                <h3>Are you sure you want to go to the solution?</h3>
                <div>
                  <button onClick={agreeAndRedirect}>Yes</button>
